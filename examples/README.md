...
- [`hello.weft`](hello.weft) — a custom effect, string composition, a named
  production terminal handler, and ordinary output.
...
./weft run examples/structured_tasks.weft
```
...
| Effects and concurrency | `effect_heavy.weft`, `state_machine.weft`, `structured_tasks.weft` |
