...
check_rejects "option_sentinel_unwrap_removed" "test/negative/option_sentinel_unwrap_removed.weft" "type error: unknown method"
check_rejects "result_sentinel_unwrap_removed" "test/negative/result_sentinel_unwrap_removed.weft" "type error: unknown method"
