...
check_rejects "deferred_k_alias_capture_lambda" "test/negative/deferred_k_alias_capture_lambda.weft" "type error: cannot capture continuation"
check_rejects "deferred_k_alias_pass_arg" "test/negative/deferred_k_alias_pass_arg.weft" "type error: continuation cannot escape"
