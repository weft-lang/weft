...
check_rejects "module_qualified_constructor_unknown" "test/negative/module_qualified_constructor_unknown.weft" "type error: unknown module member"
check_rejects "module_qualified_constructor_private" "test/negative/module_qualified_constructor_private.weft" "type error: module member is not visible"
...
check_rejects "module_qualified_trait_unknown" "test/negative/module_qualified_trait_unknown.weft" "type error: unknown module member"
check_rejects "module_qualified_trait_private" "test/negative/module_qualified_trait_private.weft" "type error: module member is not visible"
...
check_rejects "module_qualified_trait_bound_unknown" "test/negative/module_qualified_trait_bound_unknown.weft" "type error: unknown module member"
check_rejects "module_qualified_trait_bound_private" "test/negative/module_qualified_trait_bound_private.weft" "type error: module member is not visible"
...
check_rejects "vector_to_array_missing_length" "test/negative/vector_to_array_missing_length.weft" "type error: to_array length must be a non-negative integer literal"
check_rejects "vector_to_array_non_literal_length" "test/negative/vector_to_array_non_literal_length.weft" "type error: to_array length must be a non-negative integer literal"
check_rejects "vector_to_array_negative_length" "test/negative/vector_to_array_negative_length.weft" "type error: to_array length must be a non-negative integer literal"
...
check_rejects "import_cycle" "test/negative/import_cycle.weft" "error: circular import: test/negative/import_cycle -> test/negative/import_cycle_helper -> test/negative/import_cycle"
check_rejects "import_cycle_direct" "test/negative/import_cycle_direct.weft" "error: circular import: test/negative/import_cycle_direct -> test/negative/import_cycle_direct"
