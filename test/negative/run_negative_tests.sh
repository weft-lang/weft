...
check_rejects "platform_readiness_primitives_require_trusted" "test/negative/platform_readiness_primitives_require_trusted.weft" "type error: Unsafe is sealed to trusted runtime/platform code" 10
