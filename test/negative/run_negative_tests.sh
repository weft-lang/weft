...
check_rejects "dir_getcwd_requires_effect" "test/negative/dir_getcwd_requires_effect.weft" "type error: effect not available in caller"
...
check_rejects "effect_try_instantiation_mismatch" "test/negative/effect_try_instantiation_mismatch.weft" "type error: effect atom not available in caller"
