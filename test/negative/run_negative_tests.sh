...
check_rejects "structural_open_field_access" "test/negative/structural_open_field_access.weft" "type error: structural field access requires a concrete closed shape"
...
check_rejects "structural_update_nominal_shape" "test/negative/structural_update_nominal_shape.weft" "type error: nominal record functional update requires shape specialization"
