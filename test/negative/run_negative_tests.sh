...
check_rejects "slice_non_indexed" "test/negative/slice_non_indexed.weft" "type error: slicing requires an array or slice"
...
check_rejects "slice_temporary_array_owner" "test/negative/slice_temporary_array_owner.weft" "type error: slicing an array temporary requires a named owner binding"
