...
check_rejects "platform_dns_primitives_require_trusted" "test/negative/platform_dns_primitives_require_trusted.weft" "type error: Unsafe is sealed to trusted runtime/platform code" 5
