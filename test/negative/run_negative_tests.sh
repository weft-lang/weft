...
check_rejects "random_seed_constructor_private" "test/negative/random_seed_constructor_private.weft" "type error: opaque constructor is private to its declaring module; use an exported factory"
check_rejects "random_state_constructor_private" "test/negative/random_state_constructor_private.weft" "type error: opaque constructor is private to its declaring module; use an exported factory"
check_rejects "random_bound_constructor_private" "test/negative/random_bound_constructor_private.weft" "type error: opaque constructor is private to its declaring module; use an exported factory"
check_rejects "random_next_below_requires_bound" "test/negative/random_next_below_requires_bound.weft" 'error[E1002]: argument type mismatch: expected `Bound`, found `usize`'
check_rejects "property_choice_bound_constructor_private" "test/negative/property_choice_bound_constructor_private.weft" "type error: opaque constructor is private to its declaring module; use an exported factory"
check_rejects "property_choice_constructor_private" "test/negative/property_choice_constructor_private.weft" "type error: opaque constructor is private to its declaring module; use an exported factory"
...
check_rejects "http_handler_prefixed_surface_retired" "test/negative/http_handler_prefixed_surface_retired.weft" "unknown module member" 7
...
check_rejects "websocket_limits_require_usize" "test/negative/websocket_limits_require_usize.weft" 'argument type mismatch: expected `usize`, found `i64`' 2
check_rejects "websocket_payload_counts_are_usize" "test/negative/websocket_payload_counts_are_usize.weft" 'return value type mismatch: expected `i64`, found `usize`' 2
check_rejects "websocket_error_counts_require_usize" "test/negative/websocket_error_counts_require_usize.weft" 'argument type mismatch: expected `usize`, found `i64`' 12
...
check_rejects "unknown_type_record_field" "test/negative/unknown_type_record_field.weft" "error[E1001]: unknown type 'Nonexistent'"
check_rejects "unknown_type_signature" "test/negative/unknown_type_signature.weft" "error[E1001]: unknown type 'Nonexistent'"
...
check_rejects "module_qualified_type_wrong_kind" "test/negative/module_qualified_type_wrong_kind.weft" "error[E4005]: module member 'left.read' is not a type"
check_rejects "module_qualified_type_identity_mismatch" "test/negative/module_qualified_type_identity_mismatch.weft" "argument type mismatch"
...
check_rejects "alias_target_missing_arguments" "test/negative/alias_target_missing_arguments.weft" "target expects 1 arguments, found 0"
check_rejects "alias_target_excess_arguments" "test/negative/alias_target_excess_arguments.weft" "target expects 0 arguments, found 1"
check_rejects "alias_target_missing_bound" "test/negative/alias_target_missing_bound.weft" "error[E1004]"
check_rejects "alias_target_unsatisfied_bound" "test/negative/alias_target_unsatisfied_bound.weft" "error[E1004]"
check_rejects "alias_effect_callback_identity" "test/negative/alias_effect_callback_identity.weft" "error[E1002]"
check_rejects "alias_effect_wrong_handler" "test/negative/alias_effect_wrong_handler.weft" "error[E2001]"
check_rejects "alias_effect_wrong_perform" "test/negative/alias_effect_wrong_perform.weft" "error[E2001]"
check_rejects "alias_effect_identity" "test/negative/alias_effect_identity.weft" "error[E2001]"
check_rejects "local_maybe_cannot_handle_optional_chain" "test/negative/local_maybe_cannot_handle_optional_chain.weft" "error[E2001]"
check_rejects "local_fail_cannot_handle_result_propagation" "test/negative/local_fail_cannot_handle_result_propagation.weft" "error[E2001]"
check_rejects "alias_cycle_direct" "test/negative/alias_cycle_direct.weft" "error[E1007]: type alias is recursively defined"
check_rejects "alias_cycle_indirect" "test/negative/alias_cycle_indirect.weft" "error[E1007]: type alias is recursively defined"
check_rejects "alias_cycle_through_opaque" "test/negative/alias_cycle_through_opaque.weft" "recursively defined"
check_rejects "alias_missing_target" "test/negative/alias_missing_target.weft" "error[E0002]: expected target type after '='"
check_rejects "alias_unknown_target" "test/negative/alias_unknown_target.weft" "error[E1007]: type alias target name is not defined in this scope"
check_rejects "alias_missing_argument" "test/negative/alias_missing_argument.weft" "error[E1007]: type alias expects 1 arguments, found 0"
check_rejects "alias_excess_arguments" "test/negative/alias_excess_arguments.weft" "error[E1007]: type alias expects 0 arguments, found 1"
check_rejects "alias_missing_carried_bound" "test/negative/alias_missing_carried_bound.weft" "error[E1004]"
check_rejects "alias_unsatisfied_bound" "test/negative/alias_unsatisfied_bound.weft" "error[E1004]"
check_rejects "alias_erased_bound" "test/negative/alias_erased_bound.weft" "error[E1004]"
check_rejects "alias_wrong_effect_argument" "test/negative/alias_wrong_effect_argument.weft" "error[E1007]: type alias effect parameter requires an effect set or effect variable"
check_rejects "alias_fixed_effect_unhandled" "test/negative/alias_fixed_effect_unhandled.weft" "error[E2001]"
...
check_rejects "alias_nil_discrimination" "test/negative/alias_nil_discrimination.weft" "error[E1006]"
check_rejects "alias_borrow_escape" "test/negative/alias_borrow_escape.weft" "borrow"
check_rejects "alias_owned_twice" "test/negative/alias_owned_twice.weft" "owned value used more than once"
check_rejects "alias_duplicate_impl" "test/negative/alias_duplicate_impl.weft" "conflicting implementations of trait for type"
check_rejects "alias_qualified_missing" "test/negative/alias_qualified_missing.weft" "error[E4002]"
check_rejects "alias_wrong_union_member" "test/negative/alias_wrong_union_member.weft" "error[E1002]"
...
check_rejects "task_channel_outcome_type_names_retired" "test/negative/task_channel_outcome_type_names_retired.weft" "error[E4002]: unknown module member 'ChannelSend' in import"
...
check_rejects "owned_persistent_vector_field" "test/negative/owned_persistent_vector_field.weft" "type error: owned resource requires finite record, tuple, or tagged-variant storage; arbitrary containers remain unsupported"
check_rejects "owned_map_value" "test/negative/owned_map_value.weft" "type error: owned resource requires finite record, tuple, or tagged-variant storage; arbitrary containers remain unsupported"
check_rejects "owned_set_member" "test/negative/owned_set_member.weft" "type error: owned resource requires finite record, tuple, or tagged-variant storage; arbitrary containers remain unsupported"
check_rejects "owned_sorted_map_value" "test/negative/owned_sorted_map_value.weft" "type error: owned resource requires finite record, tuple, or tagged-variant storage; arbitrary containers remain unsupported"
check_rejects "owned_opaque_vector_wrapper" "test/negative/owned_opaque_vector_wrapper.weft" "type error: owned resource requires finite record, tuple, or tagged-variant storage; arbitrary containers remain unsupported"
...
check_rejects "ownership_cycle_sorted_set_self" "test/negative/ownership_cycle_sorted_set_self.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
check_rejects "ownership_cycle_vector_closure" "test/negative/ownership_cycle_vector_closure.weft" 'error[E3002]: type `CallbackBag` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_vector_closure_box" "test/negative/ownership_cycle_vector_closure_box.weft" 'error[E3002]: type `CallbackBag` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_vector_continuation" "test/negative/ownership_cycle_vector_continuation.weft" 'error[E3002]: type `ContinuationBag` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_generic_holder_vector" "test/negative/ownership_cycle_generic_holder_vector.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
check_rejects "ownership_cycle_generic_wrapper_sorted_map" "test/negative/ownership_cycle_generic_wrapper_sorted_map.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
check_rejects "ownership_cycle_hidden_capture_foreign_box" "test/negative/ownership_cycle_hidden_capture_foreign_box.weft" 'error[E3002]: type `Registry` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_hidden_capture_generator" "test/negative/ownership_cycle_hidden_capture_generator.weft" 'error[E3002]: type `Registry` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_hidden_capture_generic" "test/negative/ownership_cycle_hidden_capture_generic.weft" 'error[E3002]: type `Registry` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_hidden_capture_iterator" "test/negative/ownership_cycle_hidden_capture_iterator.weft" 'error[E3002]: type `Registry` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_hidden_capture_par_task" "test/negative/ownership_cycle_hidden_capture_par_task.weft" 'error[E3002]: type `Registry` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_hidden_capture_task" "test/negative/ownership_cycle_hidden_capture_task.weft" 'error[E3002]: type `Registry` keeps a closure environment in a mutable container'
check_rejects "ownership_cycle_map_under_vector" "test/negative/ownership_cycle_map_under_vector.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
check_rejects "ownership_cycle_mutual_generic" "test/negative/ownership_cycle_mutual_generic.weft" 'error[E3001]: type `Left` can own itself through a mutable container'
check_rejects "ownership_cycle_opaque_vector_wrapper" "test/negative/ownership_cycle_opaque_vector_wrapper.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
check_rejects "ownership_cycle_opaque_wrapper_sorted_map" "test/negative/ownership_cycle_opaque_wrapper_sorted_map.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
check_rejects "ownership_cycle_persistent_under_vector" "test/negative/ownership_cycle_persistent_under_vector.weft" 'error[E3001]: type `Node` can own itself through a mutable container'
...
check_rejects "diagnostic_range_requires_usize" "test/negative/diagnostic_range_requires_usize.weft" 'argument type mismatch: expected `usize`, found `i64`' 2
check_rejects "diagnostic_lengths_are_usize" "test/negative/diagnostic_lengths_are_usize.weft" 'return value type mismatch: expected `i64`, found `usize`' 4
check_rejects "diagnostic_sentinel_accessors_removed" "test/negative/diagnostic_sentinel_accessors_removed.weft" 'type error: unknown method' 6
